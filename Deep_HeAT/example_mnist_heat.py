# example from : https://github.com/helmholtz-analytics/heat/blob/master/examples/nn/mnist.py
...
def main():
    ...
    dataset1 = MNISTDataset(dataDir, train=True, transform=transform, ishuffle=False)
    dataset2 = MNISTDataset(
        dataDir, train=False, transform=transform, ishuffle=False, test_set=True
    )
