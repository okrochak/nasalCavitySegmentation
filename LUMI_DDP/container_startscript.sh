...
export MIOPEN_USER_DB_PATH="/mnt/tmp"
...
srun --cpu-bind=none bash -c "singularity exec --bind $SLURM_SUBMIT_DIR:/mnt \
    --bind $SCRATCH:/media --rocm torch_rocm.sif torchrun \
    --log_dir='/mnt/logs' \
    --nnodes=$SLURM_NNODES \
