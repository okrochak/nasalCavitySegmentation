...
def main(args):
    ...
    # define the (original) hyperparameter search space 
    config = {
    ...
    # Population Based Training    
        scheduler = PopulationBasedTraining(
            ...
            # the parameters of the top quantile_fraction percentage trials are transfered to the bottom quantile_fraction percentage of trials
