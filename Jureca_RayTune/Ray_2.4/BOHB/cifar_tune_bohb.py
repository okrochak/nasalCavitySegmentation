...
##
# @file cifar_tune_bohb.py
#
# @brief Optimizing the hyperparameters of a ResNet18 trained on the cifar-10 dataset with Ray Tune libray and the BOHB algorithm.
#
# @section description_cifar_tune_bohb description
...
# - hpbandster library (https://automl.github.io/HpBandSter/build/html/quickstart.html)
#   - Library for performing hyperband operations 
# - ConfigSpace library (https://automl.github.io/ConfigSpace/main/)
#   - Library to manage configuration and search spaces for hyperparameter optimization
#
...
def main(args):
    ...
    trainer = TorchTrainer(
        ...
        scaling_config=ScalingConfig(num_workers=args.par_workers, use_gpu=True, resources_per_worker={"CPU": 30, "GPU": 1}),
    )
